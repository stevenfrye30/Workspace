...
id: psalm-23
title: "Psalm 23"
summary: A short lyric of six verses in the first person — the speaker addresses God first as a shepherd through pasture, water, and the valley of deep darkness, then as a host setting a table in the presence of enemies, and resolves to dwell in the house of the LORD for length of days.
tradition: Jewish
period: c. 10th–6th c. BCE
language: Hebrew
author: Anonymous
part_of: tanakh
tags: [trust, lyric, hebrew-bible, near-eastern]
library_id: tanakh
library_book: Psalms
library_chapter: 23
---
...
Psalm 23 belongs to the first of the Psalter's five books (Psalms 1–41), the section dominated by psalms attached to David. Six verses long in the Masoretic tradition, it carries the superscription *mizmor le-David* — "a psalm of David" or "a psalm to David" — a Hebrew phrase whose grammar leaves the relation ambiguous between authorship, dedication, and tradition. The psalm is composed in two unequal halves: verses 1–4 use shepherding and water imagery; verses 5–6 turn to a table set in the presence of enemies and a dwelling in the house of the LORD. The shift from one figure to the other is one of the formal features the psalm leaves in plain view.

## Reading note

Two habits help. First, the psalm holds two metaphors in close sequence and does not reconcile them. Verses 1–4 are pastoral — shepherd, pasture, still waters, rod and staff. Verses 5–6 are domestic and ceremonial — table, oil, cup, house. The seam runs between verse 4 and verse 5 and is unhidden by the text. Reading the psalm with the seam visible — pasture and water on one side, table and house on the other — recovers a structural feature that liturgical familiarity can smooth over.
...
- **structural-parallel** → Meditations, Book 2 — paired short first-person texts spoken to compose the speaker against threat; Meditations 2 with Marcus Aurelius writing notes to himself at the start of the day, Psalm 23 with the lyric voice addressing God across pasture, valley, table, and house.
