---
id: dhammapada-chapter-1
title: "Dhammapada, Chapter 1 (The Twin Verses)"
summary: The opening chapter of the Dhammapada — twenty paired verses (1–20) on mind, action, and outcome. Müller's 1881 translation.
tradition: Buddhist
...
F. Max Müller, *The Dhammapada*, Sacred Books of the East, Vol. X (1881). Public domain via Project Gutenberg. Verses 1–20, the *Yamakavagga* — "The Twin Verses."
...
The first chapter of the Dhammapada — the *Yamakavagga*, "The Twin Verses" — opens the Buddhist tradition's best-known book of ethical verse. Its twenty verses are arranged in ten pairs, each placing a wholesome and an unwholesome version of the same situation side by side. Read together, they state the relation between mind, action, and outcome that the rest of the collection elaborates. The Dhammapada is the most widely read book of the Theravada Pali Canon and one of the oldest surviving Indian texts in any language.

## Context

The Dhammapada is one of the books of the Khuddaka Nikaya, the fifth and shortest section of the Sutta Pitaka in the Pali Canon. It collects 423 verses arranged in twenty-six chapters by theme — pairs, watchfulness, mind, flowers, the sage, evil, and so on. The verses are attributed to the Buddha and were transmitted orally for several centuries before being committed to writing in Sri Lanka in the first century BCE. The collection took shape in roughly the third century BCE, in connection with the Theravada transmission of the canon.

Chapter 1, the *Yamakavagga*, opens the book. Its twenty verses are paired: verses 1 and 2 contrast acting from a corrupted mind with acting from a clear one; subsequent pairs contrast hatred and non-hatred, sense-restraint and its absence, the recognition of what is essential and the mistaking of what is not. The pairing is the form. Each verse is short — two or four lines in the Pali — and each completes a thought.

## Reading note

Two habits help. First, the verses are paired. Each two-verse unit places a wholesome and an unwholesome version of the same situation side by side; reading verses 1 and 2 together as a unit, rather than as two separate aphorisms, recovers the form the chapter is built on.

Second, the Twin Verses are a gateway, not a doctrine. They state what follows from a mind's basic orientation but do not yet introduce the systematic teachings — the Four Noble Truths, the Eightfold Path, dependent origination — that other books of the canon develop. Reading the chapter as the opening of an ethical wisdom collection, rather than as a compressed creed, keeps it in its native proportion.

## Related

- **structural-parallel** → Egyptian Book of the Dead, Spell 125 — both bind moral conduct to its consequence; Spell 125 stages the binding as a forensic accounting before the assessor gods, the Twin Verses as the recognition that mental orientation precedes action.
- **structural-parallel** → Plato, Apology — both are civilizational ethical anchors recorded as a teacher's voice; the *Apology* preserves Socrates' ethical defense before Athens, the Dhammapada gathers the Buddha's ethical pith.

## Resources

- **Translation (loaded).** F. Max Müller, *The Dhammapada*, Sacred Books of the East, Volume X (1881), public domain via [Project Gutenberg](https://www.gutenberg.org/ebooks/2017); the version reproduced above. Bhikkhu Sujato's modern English translation (2022) is held in the library as a second translation under `dhammapada-sujato`.
