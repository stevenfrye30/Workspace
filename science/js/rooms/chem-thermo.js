...
cards: [
  ...
  { name: "Heating curve", body: "Sloped where temperature rises (q = mcΔT), flat where a phase changes (q = nΔH).", note: "A full heating-curve problem is a sum of both kinds of segment." },
  { name: "Calorimetry", body: "Heat lost by one thing = heat gained by the other: −q<sub>hot</sub> = q<sub>cold</sub>", note: "In a coffee-cup calorimeter the solution absorbs the reaction's heat." },
  { name: "Entropy", body: "ΔS measures how spread out the energy and matter are.", note: "Gas &gt; liquid &gt; solid; more particles means more entropy." },
  { name: "Gibbs free energy", body: "ΔG = ΔH − TΔS · ΔG = −RT ln K", note: "ΔG &lt; 0 ⇒ spontaneous. Temperature decides which term wins." }
],
examples: [
  ...
  { q: "Heat to melt 18.0 g of ice at 0 °C", steps: ["n = 18.0 / 18.02 = 1.00 mol", "q = n·ΔH_fus = 1.00 × 6.02 kJ/mol"], ans: "<b>6.02 kJ</b> — with no temperature change" },
  { q: "Is a reaction with ΔH &lt; 0 and ΔS &gt; 0 spontaneous?", steps: ["ΔG = ΔH − TΔS", "ΔH negative, −TΔS negative"], ans: "<b>always spontaneous</b>, at every temperature" }
],
links: [
  { name: "Reference Tables", desc: "ΔH°f values, specific heats, phase changes.", href: "room.html?room=reference", tag: "room" },
  { name: "Gases", desc: "Energy in the gas phase.", href: "room.html?room=chem-gases", tag: "room" },
  { name: "Equilibrium & Kinetics", desc: "ΔG and K are the same story.", href: "room.html?room=chem-equilibrium", tag: "room" },
